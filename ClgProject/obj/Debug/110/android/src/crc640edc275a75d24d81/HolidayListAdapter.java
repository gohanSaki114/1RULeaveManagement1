...
public class HolidayListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.HolidayListAdapter, ClgProject", HolidayListAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == HolidayListAdapter.class)
			mono.android.TypeManager.Activate ("ClgProject.HolidayListAdapter, ClgProject", "", this, new java.lang.Object[] {  });
	}

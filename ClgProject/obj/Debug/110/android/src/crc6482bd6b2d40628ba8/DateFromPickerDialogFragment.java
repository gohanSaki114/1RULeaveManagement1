...
public class DateFromPickerDialogFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.InternsFile.DateFromPickerDialogFragment, ClgProject", DateFromPickerDialogFragment.class, __md_methods);
	}


	public DateFromPickerDialogFragment ()
	{
		super ();
		if (getClass () == DateFromPickerDialogFragment.class)
			mono.android.TypeManager.Activate ("ClgProject.InternsFile.DateFromPickerDialogFragment, ClgProject", "", this, new java.lang.Object[] {  });
	}

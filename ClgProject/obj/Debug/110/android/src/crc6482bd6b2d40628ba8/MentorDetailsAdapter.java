...
public class MentorDetailsAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.InternsFile.MentorDetailsAdapter, ClgProject", MentorDetailsAdapter.class, __md_methods);
	}


	public MentorDetailsAdapter ()
	{
		super ();
		if (getClass () == MentorDetailsAdapter.class)
			mono.android.TypeManager.Activate ("ClgProject.InternsFile.MentorDetailsAdapter, ClgProject", "", this, new java.lang.Object[] {  });
	}

	public MentorDetailsAdapter (java.lang.String[] p0)
	{
		super ();
		if (getClass () == MentorDetailsAdapter.class)
			mono.android.TypeManager.Activate ("ClgProject.InternsFile.MentorDetailsAdapter, ClgProject", "System.String[], mscorlib", this, new java.lang.Object[] { p0 });
	}

...
public class LeaveStatusListAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClgProject.InternsFile.LeaveStatusListAdapter, ClgProject", LeaveStatusListAdapter.class, __md_methods);
	}


	public LeaveStatusListAdapter ()
	{
		super ();
		if (getClass () == LeaveStatusListAdapter.class)
			mono.android.TypeManager.Activate ("ClgProject.InternsFile.LeaveStatusListAdapter, ClgProject", "", this, new java.lang.Object[] {  });
	}
